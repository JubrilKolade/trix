...
export function FeatureCard({ title, description, icon, index = 0, className = "" }: FeatureCardProps) {
    return (
        ...
        >
            <div className="w-11 h-11 rounded-2xl bg-secondary flex items-center justify-center mb-6 group-hover:bg-primary group-hover:text-primary-foreground transition-all duration-300">
                {icon}
            </div>
